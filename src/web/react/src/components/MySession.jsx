  ...
  const checkQR = async () => {
    try {
      ...
      if (data.qr) {
        ...
        // Estado mientras Chrome está cargando
        ...
        <div className="rounded-xl p-8 flex items-center justify-center min-h-[320px] mb-6" style={{
          ...
          {status === 'initializing' && (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">
                Cargando navegador, espera un momento...
              </p>
          ...
          {status === 'disconnected' && (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">
                Presiona "Reiniciar Sesión" para conectar
              </p>
            </div>
          )}
        ...
        <div className="mb-6">
          {status === 'initializing' && (
            <div className="rounded-xl px-4 py-3 text-sm mb-4" style={{
              ...
              border: '1px solid rgba(27, 127, 74, 0.2)',
              color: '#166534'
            }}>
              <div className="flex items-start gap-2">
                ...
                <span>Iniciando navegador para WhatsApp...</span>
              </div>
            </div>
          )}
