      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="mt-6">
          ...
          <button
            ...
            onMouseEnter={(e) => !isResetting && (e.target.style.background = '#156B3D')}
            onMouseLeave={(e) => !isResetting && (e.target.style.background = '#1B7F4A')}
          >
            {isResetting ? (
              <>
          ...
          <div className="mt-6 pt-6 rounded-xl p-4" style={{
            ...
            <ol className="space-y-2 text-xs text-gray-600">
              <li className="flex items-start gap-2">
                <span className="flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-semibold text-white" style={{ background: '#1B7F4A' }}>1</span>
                <span>Abre WhatsApp en tu teléfono</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-semibold text-white" style={{ background: '#1B7F4A' }}>2</span>
                <span>Ve a Configuración → Dispositivos vinculados</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-semibold text-white" style={{ background: '#1B7F4A' }}>3</span>
                <span>Toca "Vincular dispositivo"</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-semibold text-white" style={{ background: '#1B7F4A' }}>4</span>
              ...
              {activePromptTab === 'group' ? (
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    style={{
                      background: groupsAIEnabled ? '#1B7F4A' : '#E8EBED'
                    }}
                  >
                    <span
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
                    style={{
                      background: individualAIEnabled ? '#1B7F4A' : '#E8EBED'
                    }}
                  >
                    <span
                      className="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out"
          ...
          <div className="flex gap-2 mb-6 border-b" style={{ borderColor: '#E8EBED' }}>
            ...
            >
              ...
              {activePromptTab === 'individual' && (
                <div className="absolute bottom-0 left-0 right-0 h-0.5" style={{ background: '#1B7F4A' }}></div>
              )}
            </button>
            <button
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex-1 mb-4">
                <textarea
                  ...
                  className="w-full h-full px-4 py-3 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent font-mono resize-none"
                  style={{
                    borderColor: '#E8EBED',
                    background: '#FAFBFC',
                    minHeight: '400px'
              ...
              {(hasIndividualChanges && activePromptTab === 'individual') || (hasGroupChanges && activePromptTab === 'group') ? (
                <div className="flex gap-3">
                  <button
                    ...
                    onMouseEnter={(e) => !savingAll && (e.target.style.background = '#156B3D')}
                    onMouseLeave={(e) => !savingAll && (e.target.style.background = '#1B7F4A')}
                  >
                    {savingAll ? (
                      <>
                        <div className="animate-spin rounded-full h-4 w-4 border-2 border-white border-t-transparent"></div>
