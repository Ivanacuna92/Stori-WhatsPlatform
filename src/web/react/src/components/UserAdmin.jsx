    ...
    <div className="p-8 max-w-7xl mx-auto" style={{ background: '#FAFBFC', minHeight: '100vh' }}>
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          ...
          onMouseEnter={(e) => e.target.style.background = '#4c10d4'}
          onMouseLeave={(e) => e.target.style.background = '#5c19e3'}
        >
          + Crear Usuario
        </button>
      </div>
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full flex items-center justify-center text-white text-sm font-semibold" style={{
                      background: user.active ? 'linear-gradient(135deg, #5c19e3 0%, #4c10d4 100%)' : '#9CA3AF'
                    }}>
